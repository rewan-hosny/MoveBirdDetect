...
class ClsMotion(object):
    ...
    def get_motion_per_time(self, dict_frame_time):
        ...
        row = dict({"Time": 0, "No Motion": '', "No Motion Time Span": '',
                    'headstatus': '',      "head movement": '', "head movement time span": '',
                    'legstatus': '',       "leg movement": '', "leg movement time span": '',
                    'wingstatus': '',      "wing movement": '', "wing movement time span": '',
                    'tailstatus': '',       "tail movement": '', "tail movement time span": ''})
        tbl_movement = []
                        ...
                        if not dict_pose_change[birdPart]:
                            ...
                            if (len(tbl_movement) != 0 and tbl_movement[len(tbl_movement)-1]['Time'] == new_row['Time']):
                                if tbl_movement[len(tbl_movement)-1]['head movement'] == '' and new_row['head movement'] != '':
                                    ...
                                    tbl_movement[len(
                                        tbl_movement)-1]['headstatus'] = new_row['headstatus']
                                ...
                                if tbl_movement[len(tbl_movement)-1]['leg movement'] == '' and new_row['leg movement'] != '':
                                    ...
                                    tbl_movement[len(
                                        tbl_movement)-1]['legstatus'] = new_row['legstatus']
                                ...
                                if tbl_movement[len(tbl_movement)-1]['wing movement'] == '' and new_row['wing movement'] != '':
                                    ...
                                    tbl_movement[len(
                                        tbl_movement)-1]['wingstatus'] = new_row['wingstatus']
                                ...
                                if tbl_movement[len(tbl_movement)-1]['tail movement'] == '' and new_row['tail movement'] != '':
                                    ...
                                    tbl_movement[len(
                                        tbl_movement)-1]['tailstatus'] = new_row['tailstatus']
    ...
    def data_frame(self, file_name, change):
        ...
        export_details.columns = ["No Motion", "No Motion\n Time Span (sec)",
                                  'headstatus', "head movement", "head movement\n time span",
                                  'legstatus',  "leg movement", "leg movement\n  time span",
                                  'wingstatus',   "wing movement", "wing movement\n  time span",
                                  'tailstatus',    "tail movement", "tail movement\n  time span"]
